      ...
      <div className="container mx-auto px-4 md:px-6 py-8 max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          >
            ...
            <div className="mb-6">
              <h4 className="font-semibold text-sm text-gray-900 mb-3 uppercase tracking-wide flex items-center gap-2">
                <GraduationCap size={14} className="text-legpro-primary" />
                Education
              </h4>
              <div className="space-y-1.5">
                {["10th", "12th", "Diploma", "Graduate", "Post Graduate"].map((edu) => (
                  <label
                    key={edu}
                    className="flex items-center px-3 py-2.5 rounded-lg cursor-pointer hover:bg-blue-50 transition-colors group"
                  >
                    <input
                      type="radio"
                      name="education"
                      checked={searchFilter.education === edu}
                      onChange={() => setSearchFilter(prev => ({ ...prev, education: edu }))}
