...
const Navbar = () => {
  ...
  const navigationItems = [
    ...
    { name: "Campus Partner", href: "/post-jobs", icon: Briefcase },
  ];
        ...
        <div className="container flex h-16 items-center justify-between px-4 mx-auto max-w-7xl">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm text-muted-foreground -mt-1 font-bold text-right">
                .Co.In
              </span>
            </div>
          </Link>
            ...
            {isUserAuthenticated ? (
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="bg-legpro-primary hover:bg-legpro-primary-hover text-white shadow-md hover:shadow-lg transition-all text-sm px-3 py-2"
                >
                ...
                <Button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white shadow-md hover:shadow-lg transition-all text-sm px-3 py-2"
                >
                  ...
                  {isUserAuthenticated ? (
                    ...
                    <div className="border-t pt-4 space-y-2">
                      <Button
                        ...
                        className="w-full bg-legpro-primary hover:bg-legpro-primary-hover text-white shadow-md"
                      >
