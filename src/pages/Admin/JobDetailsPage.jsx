        ...
        <div className="bg-white shadow-lg rounded-xl p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
              ...
              <p><strong>Salary:</strong> {typeof job.salary === "number" ? (job.salary >= 100000 ? `${(job.salary / 100000).toFixed(1).replace(/\.0$/, '')}L` : (job.salary >= 1000 ? `${(job.salary / 1000).toFixed(0)}K` : job.salary)) : (typeof job.salary === "string" ? job.salary.replace(/\$/g, "").replace(/₹/g, "").trim() : "N/A")}</p>
